...
namespace org.neurul.Brain.Port.Adapter.IO.Persistence.Events.Test.EventSerializerFixture.given
{
    ...
    public class When_deserializing_NeuronDataChanged_event : Context
    {
        ...
        protected override void When()
        {
            ...
            this.deserializedEvent = this.sut.Deserialize(
                "org.neurul.Brain.Domain.Model.Neurons.NeuronDataChanged, org.neurul.Brain.Domain.Model, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null",
                @"{
                  ""Data"": """ + Data + @""",
                  ""Id"": """ + TestGuid + @""",
                  ""Version"": 6,
